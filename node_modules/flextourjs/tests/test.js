...
actionsList.moveToStep = function () {
    flexTour.moveTo(4);
};
...
var translated = {
    translated1: "Dòng dịch thứ 1",
    translated2: "Dòng dịch thứ 2"
};
...
document.querySelector("#trigger").onclick = function () {
    flexTour = new FlexTour(tourDesc, actionsList, translated);
    flexTour.run();
};
