...
export class Attributes extends React.Component<{}, {}> {
    ...
    private _regularTourRunner():JSX.Element {
        ...
        let buttons: JSX.Element = this._linkToDemoAndSource("../../../../demo/simple/index.html", "regular");
    ...
    private _prerequisitesAndBranching():JSX.Element {
        ...
        let buttons: JSX.Element = this._linkToDemoAndSource("../../../../demo/errorcheckings/index.html", "prerequisite");
        return this._attributeContentBlock(body, buttons);
    }
    ...
    private _waitForElementAndFinalResort():JSX.Element {
        ...
        let buttons: JSX.Element = this._linkToDemoAndSource("../../../../demo/longprocess/index.html", "wait");
        return this._attributeContentBlock(body, buttons);
    }
    ...
    private _multipagePauseAndResume():JSX.Element {
        ...
        let buttons: JSX.Element = this._linkToDemoAndSource("../../../../demo/multipage/index.html", "multipage");
        return this._attributeContentBlock(body, buttons);
    }
    ...
    private _nextTriggerDnD():JSX.Element {
        ...
        let buttons: JSX.Element = this._linkToDemoAndSource("../../../../demo/customizedtriggers/index.html", "trigger");
        return this._attributeContentBlock(body, buttons);
    }
    ...
    private _standaloneBubble():JSX.Element {
        ...
        let buttons: JSX.Element = this._linkToDemoAndSource("../../../../demo/customizedstyles/index.html", "standalone");
        return this._attributeContentBlock(body, buttons);
    }
    ...
    private _floatingElements():JSX.Element {
        ...
        let buttons: JSX.Element = this._linkToDemoAndSource("../../../../demo/coolfeatures/index.html", "floating");
        return this._attributeContentBlock(body, buttons);
    }
    ...
    private _nlsTranslation():JSX.Element {
        ...
        let buttons: JSX.Element = this._linkToDemoAndSource("../../../../demo/translation/index.html", "floating");
        return this._attributeContentBlock(body, buttons);
    }
}