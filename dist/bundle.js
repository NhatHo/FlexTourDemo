            ...
            NavBar.prototype.render = function () {
                if (this.props.floating) {
                    ...
                    return React.createElement("nav", {
                        className: "navbar navbar-inverse navbar-static-top",
                        id: "navbar"
                    }, React.createElement("div", {className: "container"}, React.createElement("div", {className: "collapse navbar-collapse"}, React.createElement("ul", {className: "nav navbar-nav"}, React.createElement("li", null, React.createElement("a", {onClick: this.scrollTop.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-home"}), " Top")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToDesc.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-plus-sign"}), " Features")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToAttributes.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-play"}), " Demo")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToWiki.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-book"}), " Api"))))));
                }
            };
