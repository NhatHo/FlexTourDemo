...
/***/ function(module, exports, __webpack_require__) {
	...
	var Description = (function (_super) {
	    ...
	    Description.prototype.render = function () {
	        return (React.createElement("section", {id: "desc"}, React.createElement(SectionHeader_1.SectionHeader, {header: "What's New?", subHeader: "The developers now can fully control the flow of the tour to compensate for application's performance."}), React.createElement("div", {className: "container"}, React.createElement("div", {className: "row text-center"}, React.createElement(NewFeatures_1.NewFeatures, {title: "Shall you pass?", content: "You can check if the next step should be showed or not. FlexTourJS will not show the next step until all prerequisites are met.", icon: "fa-check-square", code: "prerequisites: ['condition1','condition2', ...]"}), React.createElement(NewFeatures_1.NewFeatures, {title: "Are you ready?", content: "Processing might take some time, FlexTourJs ensures that the next step will be displayed after your application has completed rendering.", icon: "fa-clock-o", code: "prerequisites: ['?isVisible:params', ...]"}), React.createElement(NewFeatures_1.NewFeatures, {title: "Uh oh!", content: "When the target of your next step does not show or it is conditional, you can set up a back up route and FlexTourJS will flow to it.", icon: "fa-meh-o", code: "skip: {branch-step-number}, prerequisites: ['!proceedCondition:params', ...]"})), React.createElement("div", {className: "row text-center"}, React.createElement(NewFeatures_1.NewFeatures, {title: "Power!!!", content: "The power is in your hands, you can create new bubble styles, add new buttons and attach functionalities to them. Let your imagination run wild.", icon: "fa-unlock", code: "buttons:[{name: '', style: '', onclick: func()}, ...]"}), React.createElement(NewFeatures_1.NewFeatures, {title: "Show off features?", content: "FlexTourJS will not limit your application in any way, you can do drag and drop, popup menu, dropdown menu, etc. without breaking your flow.", icon: "fa-arrows", code: "dragAndDrop:true, modal:true, ..."}), React.createElement(NewFeatures_1.NewFeatures, {title: "Everyone can use it!", content: "Yes, everyone can use it because FlexTourJS comes with NLS ready as well as fully accessible using keyboard.", icon: "fa-universal-access", code: "nextButton:{newName}, backButton:{newName}, skipButton:{newName}, doneButton:{newName}, ..."})))));
	    };
	    return Description;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Attributes = (function (_super) {
	    ...
	    Attributes.prototype._regularTourRunner = function () {
	        ...
	        var buttons = this._linkToDemoAndSource("../../../../demo/simple/index.html", "https://github.com/NhatHo/FlexTourDemo/tree/master/demo/simple");
	    ...
	    Attributes.prototype._prerequisitesAndBranching = function () {
	        ...
	        var buttons = this._linkToDemoAndSource("../../../../demo/errorcheckings/index.html", "https://github.com/NhatHo/FlexTourDemo/tree/master/demo/errorcheckings");
	        return this._attributeContentBlock(body, buttons);
	    };
	    Attributes.prototype._waitForElementAndFinalResort = function () {
	        ...
	        var buttons = this._linkToDemoAndSource("../../../../demo/longprocess/index.html", "https://github.com/NhatHo/FlexTourDemo/tree/master/demo/longprocess");
	        return this._attributeContentBlock(body, buttons);
	    };
	    Attributes.prototype._multipagePauseAndResume = function () {
	        ...
	        var buttons = this._linkToDemoAndSource("../../../../demo/multipage/index.html", "https://github.com/NhatHo/FlexTourDemo/tree/master/demo/multipage");
	        return this._attributeContentBlock(body, buttons);
	    };
	    Attributes.prototype._nextTriggerDnD = function () {
	        ...
	        var buttons = this._linkToDemoAndSource("../../../../demo/customizedtriggers/index.html", "https://github.com/NhatHo/FlexTourDemo/tree/master/demo/customizedtriggers");
	        return this._attributeContentBlock(body, buttons);
	    };
	    Attributes.prototype._standaloneBubble = function () {
	        ...
	        var buttons = this._linkToDemoAndSource("../../../../demo/customizedstyles/index.html", "https://github.com/NhatHo/FlexTourDemo/tree/master/demo/customizedstyles");
	        return this._attributeContentBlock(body, buttons);
	    };
	    Attributes.prototype._floatingElements = function () {
	        ...
	        var buttons = this._linkToDemoAndSource("../../../../demo/coolfeatures/index.html", "https://github.com/NhatHo/FlexTourDemo/tree/master/demo/coolfeatures");
	        return this._attributeContentBlock(body, buttons);
	    };
	    Attributes.prototype._nlsTranslation = function () {
	        ...
	        var buttons = this._linkToDemoAndSource("../../../../demo/translation/index.html", "https://github.com/NhatHo/FlexTourDemo/tree/master/demo/translation");
	        return this._attributeContentBlock(body, buttons);
	    };
	    return Attributes;
	}(React.Component));
	...
	var NavBar = (function (_super) {
	    ...
	    NavBar.prototype.render = function () {
	        if (this.props.floating) {
	            return React.createElement("span", null, React.createElement("nav", {className: "navbar navbar-inverse navbar-static-top", id: "navbar"}, React.createElement("div", {className: "container"}, React.createElement("div", {className: "collapse navbar-collapse"}, React.createElement("ul", {className: "nav navbar-nav"}, React.createElement("li", null, React.createElement("a", {onClick: this.scrollTop.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-home"}), " Top")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToDesc.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-plus-sign"}), " Features")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToAttributes.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-play"}), " Demo")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToWiki.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-book"}), " Api")))))), React.createElement("div", {className: "sticky"}, React.createElement("ul", {className: "floating-nav"}, React.createElement("li", null, React.createElement("a", {onClick: this.scrollTop.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-home"}), " Top")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToDesc.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-plus-sign"}), " Features")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToAttributes.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-play"}), " Demo")), React.createElement("li", null, React.createElement("a", {onClick: this.scrollToWiki.bind(this)}, React.createElement("span", {className: "glyphicon glyphicon-book"}), " Api")))));
	        }
	        else {
